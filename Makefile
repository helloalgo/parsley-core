CC = g++
CFLAGS = -W -Wall -O2 -Iinclude -fcompare-debug-second -g -fpermissive
...
TARGET = realcore
OBJECTS = judge.o main.o runner/child.o runner/seccomp.o runner/timeout.o runner/watch.o util.o
